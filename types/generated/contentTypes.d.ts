...
export interface ApiContentPerformingStudentContentPerformingStudent
  extends Schema.CollectionType {
  collectionName: 'content_performing_students';
  info: {
...
export interface ApiTopPerformingStudentTopPerformingStudent
  extends Schema.CollectionType {
  collectionName: 'top_performing_students';
  info: {
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::top-performing-student.top-performing-student',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiYoutubeCodingVideoYoutubeCodingVideo
  extends Schema.CollectionType {
  collectionName: 'youtube_coding_videos';
  info: {
    singularName: 'youtube-coding-video';
    pluralName: 'youtube-coding-videos';
    displayName: 'Youtube Coding Video';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::youtube-coding-video.youtube-coding-video',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiYoutubeVideoYoutubeVideo extends Schema.CollectionType {
  ...
  attributes: {
    Links: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
